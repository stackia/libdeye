...
final class MyCollectActivity$requestPageList$flowable$3<T> implements Consumer {
    final /* synthetic */ String $startId;
    final /* synthetic */ MyCollectActivity this$0;

    MyCollectActivity$requestPageList$flowable$3(MyCollectActivity myCollectActivity, String str) {
    ...
    public final void accept(BaseResult<List<FindItemBean>> it2) {
        ...
        if (meta != null && meta.getCode() == 0) {
            ...
            if (data != null) {
                ...
                if (str == null) {
                    myCollectActivity.getAdapter().setData(data);
                } else {
                    myCollectActivity.getAdapter().addData(data);
                }
            }
