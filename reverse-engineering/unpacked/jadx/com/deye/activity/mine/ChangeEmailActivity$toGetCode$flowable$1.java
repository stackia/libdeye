...
final class ChangeEmailActivity$toGetCode$flowable$1<T> implements Consumer {
    final /* synthetic */ ChangeEmailActivity this$0;

    ChangeEmailActivity$toGetCode$flowable$1(ChangeEmailActivity changeEmailActivity) {
    ...
    public final void accept(BaseResult<VerificationResultBean> it2) {
        ...
        if (it2.getData() != null) {
            ...
            BaseUtils.showShortToast((Context) changeEmailActivity.mContext, changeEmailActivity.getString(R.string.email_verification_code_sent));
        }
    }
}
