...
final class CleanAccountActivity$toGetCode$flowable$1<T> implements Consumer {
    final /* synthetic */ CleanAccountActivity this$0;

    CleanAccountActivity$toGetCode$flowable$1(CleanAccountActivity cleanAccountActivity) {
    ...
    public final void accept(BaseResult<VerificationResultBean> it2) {
        ...
        if (it2.getData() != null) {
            ...
            BaseUtils.showShortToast((Context) cleanAccountActivity.mContext, cleanAccountActivity.getString(R.string.get_verification_code_success));
        }
    }
}
