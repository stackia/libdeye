...
final class CleanAccountActivity$sendEmailVerificationCode$getEmailVerCodeApi$2<T> implements Consumer {
    final /* synthetic */ CleanAccountActivity this$0;

    CleanAccountActivity$sendEmailVerificationCode$getEmailVerCodeApi$2(CleanAccountActivity cleanAccountActivity) {
    ...
    public final void accept(Throwable error) {
        ...
        LogUtil.e(StubApp.getString2(13742), StubApp.getString2(13715) + error.getMessage());
