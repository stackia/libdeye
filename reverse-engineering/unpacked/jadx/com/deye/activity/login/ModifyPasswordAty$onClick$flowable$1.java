...
final class ModifyPasswordAty$onClick$flowable$1<T> implements Consumer {
    final /* synthetic */ ModifyPasswordAty this$0;

    ModifyPasswordAty$onClick$flowable$1(ModifyPasswordAty modifyPasswordAty) {
    ...
    public final void accept(BaseResult<VerificationResultBean> it2) {
        ...
        if (it2.getData() != null) {
            ...
            ModifyPwdAtyBinding modifyPwdAtyBinding = modifyPasswordAty.mModifyPwdAtyBinding;
            ...
            modifyPwdAtyBinding.btnNext.setEnabled(true);
        }
    }
}
