...
final class ModifyPasswordAty$onClick$flow$2<T> implements Consumer {
    final /* synthetic */ ModifyPasswordAty this$0;

    ModifyPasswordAty$onClick$flow$2(ModifyPasswordAty modifyPasswordAty) {
    ...
    public final void accept(BaseResult<VerificationResultBean> it2) {
        ...
        if (meta != null && meta.getCode() == 0) {
            BaseUtils.showShortToast(R.string.modify_password_success);
            this.this$0.finish();
            return;
        }
        ...
        BaseUtils.showShortToast((Context) this.this$0.mContext, message.toString());
    }
}
