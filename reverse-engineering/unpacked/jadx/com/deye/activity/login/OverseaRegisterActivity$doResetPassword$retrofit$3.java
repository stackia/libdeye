...
final class OverseaRegisterActivity$doResetPassword$retrofit$3<T> implements Consumer {
    final /* synthetic */ OverseaRegisterActivity this$0;

    OverseaRegisterActivity$doResetPassword$retrofit$3(OverseaRegisterActivity overseaRegisterActivity) {
    ...
    public final void accept(Throwable error) {
        ...
        LogUtil.e(StubApp.getString2(13704), StubApp.getString2(13714) + error.getMessage());
