...
final class OverseaRegisterActivity$checkEmailExists$checkEmailApi$2<T> implements Consumer {
    final /* synthetic */ OverseaRegisterActivity this$0;

    OverseaRegisterActivity$checkEmailExists$checkEmailApi$2(OverseaRegisterActivity overseaRegisterActivity) {
    ...
    public final void accept(Throwable error) {
        ...
        LogUtil.e(StubApp.getString2(13704), StubApp.getString2(13703) + error.getMessage());
