...
final class OverseaRegisterActivity$doChangePassword$retrofit$2<T> implements Consumer {
    final /* synthetic */ OverseaRegisterActivity this$0;

    OverseaRegisterActivity$doChangePassword$retrofit$2(OverseaRegisterActivity overseaRegisterActivity) {
    ...
    public final void accept(BaseResult<VerificationResultBean> response) {
        ...
        if (meta != null && meta.getCode() == 0) {
            LogUtil.d(StubApp.getString2(13704), StubApp.getString2(13706));
            OverseaRegisterActivity overseaRegisterActivity = this.this$0;
            BaseUtils.showShortToast((Context) overseaRegisterActivity, overseaRegisterActivity.getString(R.string.change_password_success));
            this.this$0.finish();
            return;
        }
        BaseResult.MetaBean meta2 = response.getMeta();
        if (meta2 == null || (string2 = meta2.getMessage()) == null) {
            string2 = StubApp.getString2(13707);
        }
