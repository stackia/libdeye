...
final class AddAppointmentAty$saveAppointment$result$1<T> implements Consumer {
    final /* synthetic */ AddAppointmentAty this$0;

    AddAppointmentAty$saveAppointment$result$1(AddAppointmentAty addAppointmentAty) {
    ...
    public final void accept(BaseResult<SimpleResultBean> it2) {
        ...
        if (code == 0) {
            BaseUtils.showShortToast(R.string.save_success);
            ...
            ToastUtils.showToast(context, String.valueOf(meta2 != null ? meta2.getMessage() : null));
        }
    }
}
