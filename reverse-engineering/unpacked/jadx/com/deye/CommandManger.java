...
public final class CommandManger {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendPowerCommand$lambda$4(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendPowerCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 1, i == 1 ? (byte) 1 : (byte) 0});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendWindSwitchCommand$lambda$5(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendWindSwitchCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 2, i == 1 ? (byte) 1 : (byte) 0});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendSpeedCommand$lambda$6(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendSpeedCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 9, (byte) i});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendWaterPumpCommand$lambda$7(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendWaterPumpCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 6, i == 1 ? (byte) 1 : (byte) 0});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendNegativeIonCommand$lambda$8(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendNegativeIonCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 7, i == 1 ? (byte) 1 : (byte) 0});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendLockCommand$lambda$9(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendLockCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 3, i == 1 ? (byte) 1 : (byte) 0});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendLoopCommand$lambda$10(LoopFanBean loopFanBean, String deviceId, String productId) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendModeCommand$lambda$11(boolean z, boolean z2, String mode, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(mode, "$mode");
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendModeCommand(deviceId, Integer.parseInt(mode), bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 8, (byte) Integer.parseInt(mode)});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendHumidityCommand$lambda$12(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendHumidityCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 10, (byte) i});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendTempCommand$lambda$13(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendTempCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, 10, (byte) i});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendSleepCommand$lambda$14(boolean z, boolean z2, int i, String deviceId, String productId, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(productId, "$productId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        if (z) {
            FogDeviceManager.INSTANCE.sendSleepCommand(deviceId, i, bean);
        } else if (z2) {
            INSTANCE.sendSingleCommand(deviceId, productId, new byte[]{17, ek.m, (byte) i});
        } else {
            INSTANCE.sendCommand(deviceId, productId, bean);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void sendPoweroffTimeCommand$lambda$15(String deviceId, int i, DehumidifierBean bean) {
        Intrinsics.checkNotNullParameter(deviceId, "$deviceId");
        Intrinsics.checkNotNullParameter(bean, "$bean");
        FogDeviceManager.INSTANCE.sendPoweroffTimeCommand(deviceId, i, bean);
    }
