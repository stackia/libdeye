...
public class QuiltDryerModeWarmQuiltModeAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public QuiltDryerModeWarmQuiltModeAdapter(Context context, ModeWarmQuiltModeBean modeWarmQuiltModeBean) {
        this.context = context;
        this.mSpeedName = modeWarmQuiltModeBean.getName();
        this.mSpeedValue = modeWarmQuiltModeBean.getValue();
        this.mSpeedIconNormal = modeWarmQuiltModeBean.getIconNormal();
        this.mSpeedIconSelected = modeWarmQuiltModeBean.getIconSelected();
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.quilt_dryer_mode_wram_quilt_mode_ry_wind_speed_item, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.deye.adapter.QuiltDryerModeWarmQuiltModeAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                QuiltDryerModeWarmQuiltModeAdapter.this.mModeSelectedItem = i;
                QuiltDryerModeWarmQuiltModeAdapter.this.notifyDataSetChanged();
                if (QuiltDryerModeWarmQuiltModeAdapter.this.mIOnClickItemListener != null) {
                    QuiltDryerModeWarmQuiltModeAdapter.this.mIOnClickItemListener.onOnClickItem(i);
                }
            }
        });
    }
