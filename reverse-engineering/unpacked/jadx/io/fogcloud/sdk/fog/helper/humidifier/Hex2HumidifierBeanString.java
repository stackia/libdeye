package io.fogcloud.sdk.fog.helper.humidifier;
...
public class Hex2HumidifierBeanString {
    private static String TAG = StubApp.getString2(45143);

    public static DehumidifierBean getHumidifierBeanString(JSONObject jSONObject) {
        String string2 = StubApp.getString2(45144);
        Log.d(TAG, StubApp.getString2(45145) + jSONObject.toString());
    ...
    public static DehumidifierBean getHumidifierBeanString(String str) {
