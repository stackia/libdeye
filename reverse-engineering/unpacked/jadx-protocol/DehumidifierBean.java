...
public class DehumidifierBean implements Serializable {
    public String A1;
    public String A2;
    public String A3;
    public String A4;
    ...
    public String temperature_set;
    public String uvLight;
    public String waterStatus;
    private String watertank_state;
    public int watertankcapacity;
    public int wetCurtainOperationDuration;
    ...
    public String getHkmodeoperation() {
        return this.hkmodeoperation;
    }

    public void setHkmodeoperation(String str) {
        this.hkmodeoperation = str;
    }

    public String getHkallowstatus() {
        return this.hkallowstatus;
    }

    public void setHkallowstatus(String str) {
    ...
    public boolean checkIsDehumidifyMode() {
        return this.mode.equals("0") || this.mode.equals("5");
    }

    public boolean checkIsAirMode() {
        return this.mode.equals("2");
    }

    public boolean checkIsPowerOn() {
        String str = this.sys_switch;
        if (str != null) {
            return str.equals("1");
        }
        return false;
    ...
    public String toString() {
        return "DehumidifierBean{anion_switch='" + this.anion_switch + "', fan_switch='" + this.fan_switch + "', lock_switch='" + this.lock_switch + "', mode='" + this.mode + "', pump_switch='" + this.pump_switch + "', speed='" + this.speed + "', sys_switch='" + this.sys_switch + "', wind_switch='" + this.wind_switch + "', hum_set='" + this.hum_set + "', current_env_hum='" + this.current_env_hum + "'}";
    }
